  ...
  return (
    <Card className="panel source-controls">
      <CardHeader>
        ...
        <CardDescription>
          Generate, pause, and set the event rate for each local source.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {sources.map((source) => (
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          <div className="local-badge">
            <span className="pulse-dot" /> LOCAL DEMO <span>•</span> OFFLINE
            READY
          </div>
      ...
      <div className="main-shell">
            ...
            <>
              ...
              <div className="metric-grid">
                <Kpi
                  ...
                  sub="Measured in this local run"
                />
                <Kpi
                  icon={ShieldX}
                  label="Quarantined"
              ...
              <div className="two-column">
                ...
                <Card className="panel source-panel">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Deterministic samples generated on this laptop.
                    </CardDescription>
                  </CardHeader>
            ...
            <>
              ...
              <Card className="panel">
                <CardHeader>
                  ...
                  <CardDescription>
                    Actual events stored by the local backend.
                  </CardDescription>
                </CardHeader>
            ...
            <>
              ...
              <Card className="panel">
                <CardHeader>
                  ...
                  <CardDescription>
                    {quarantined.length} locally stored event(s)
                  </CardDescription>
                </CardHeader>
                <CardContent className="table-scroll">
                  <Table>
                ...
                <Card className="panel empty-panel">
                  <CardContent>
                    ...
                    <p>
                      ...
                      and regressions on this laptop.
                    </p>
                  </CardContent>
                </Card>
              )}
        ...
        <footer className="footer">
          <span>
            <span className="pulse-dot" /> Local-first prototype · data stays on
            this laptop
          </span>
          <Button
            variant="ghost"
